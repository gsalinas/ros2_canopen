...
#ifndef NODE_CANOPEN_AMC_DRIVER
#define NODE_CANOPEN_AMC_DRIVER
...
class NodeCanopenAMCDriver : public NodeCanopenProxyDriver<NODETYPE>
{
  static_assert(
...
protected:
  std::shared_ptr<MotorAMC> motor_;
...
public:
  NodeCanopenAMCDriver(NODETYPE * node);
   ...
   *
   * Calls MotorAMC::handleInit function. Brings motor to enabled
   * state and homes it.
   *
   * @param [in] request
   * @param [out] response
   ...
   *
   * Calls MotorAMC::handleEnable function. Brings motor to enabled
   * state.
   *
   * @param [in] request
   * @param [out] response
   ...
   *
   * Calls MotorAMC::handleDisable function. Brings motor to switched on
   * disabled state.
   *
   * @param [in] request
   * @param [out] response
   ...
   *
   * Calls MotorAMC::handleRecover function. Resets faults and brings
   ...
   *
   * Calls MotorAMC::handleHalt function. Calls Quickstop. Resulting
   ...
   *
   * Calls MotorAMC::enterModeAndWait with requested Operation Mode.
   *
   ...
   *
   * Calls MotorAMC::enterModeAndWait with Profiled Position Mode as
   ...
   *
   * Calls MotorAMC::enterModeAndWait with Profiled Velocity Mode as
   * Target Operation Mode. If successful, the motor was transitioned
   ...
   *
   * Calls MotorAMC::enterModeAndWait with Cyclic Position Mode as
   * Target Operation Mode. If successful, the motor was transitioned
   ...
   *
   * Calls MotorAMC::enterModeAndWait with Interpolated Position Mode as
   * Target Operation Mode. If successful, the motor was transitioned
   ...
   *
   * Calls MotorAMC::enterModeAndWait with Cyclic Velocity Mode as
   * Target Operation Mode. If successful, the motor was transitioned
   ...
   *
   * Calls MotorAMC::enterModeAndWait with Profiled Torque Mode as
   * Target Operation Mode. If successful, the motor was transitioned
   ...
   *
   * Calls MotorAMC::enterModeAndWait with Cyclic Torque Mode as
   * Target Operation Mode. If successful, the motor was transitioned
   ...
   *
   * Calls MotorAMC::setTarget and sets the requested target value. Note
